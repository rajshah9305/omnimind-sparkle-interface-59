    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-omni-light">
      <header className="py-4 px-6 flex justify-between items-center backdrop-blur-sm bg-white/80 sticky top-0 z-10 border-b border-gray-100">
        ...
        <div className="hidden md:flex gap-4">
          <Button variant="ghost" className="hover:bg-omni-light hover:text-omni-primary">Features</Button>
          <Button variant="ghost" className="hover:bg-omni-light hover:text-omni-primary">About</Button>
          <Button variant="ghost" className="hover:bg-omni-light hover:text-omni-primary">Help</Button>
        </div>
